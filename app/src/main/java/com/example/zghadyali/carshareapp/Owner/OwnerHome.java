...
public class OwnerHome extends Fragment {
    ...
    public ArrayAdapter requestAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        requestAdapter = new ArrayAdapter<String>(getActivity(), R.layout.text_view);
...
//        owneractivity.getfuturecurrentRequests();
        ...
        if (owneractivity.getFutureRequestsArray().size() == 0){
            ...
            Log.d("HERE", "jiu");
            carsListView = (ListView) view.findViewById(R.id.requests_list);
            requestAdapter = new com.example.zghadyali.carshareapp.Owner.RequestAdapter(getContext(), owneractivity.getFutureRequestsArray());
            carsListView.setAdapter(requestAdapter);
        }
